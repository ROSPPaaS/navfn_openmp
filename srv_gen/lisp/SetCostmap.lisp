...
(cl:defmethod cl:initialize-instance :after ((m <SetCostmap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCostmap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navfn_openmp-srv:<SetCostmap-request> is deprecated: use navfn_openmp-srv:SetCostmap-request instead.")))

(cl:ensure-generic-function 'costs-val :lambda-list '(m))
(cl:defmethod costs-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navfn_openmp-srv:costs-val is deprecated.  Use navfn_openmp-srv:costs instead.")
  (costs m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navfn_openmp-srv:height-val is deprecated.  Use navfn_openmp-srv:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navfn_openmp-srv:width-val is deprecated.  Use navfn_openmp-srv:width instead.")
  (width m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCostmap-request>)))
  ...
  "navfn_openmp/SetCostmapRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCostmap-request)))
  "Returns string type for a service object of type 'SetCostmap-request"
  "navfn_openmp/SetCostmapRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCostmap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCostmap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navfn_openmp-srv:<SetCostmap-response> is deprecated: use navfn_openmp-srv:SetCostmap-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCostmap-response>)))
  ...
  "navfn_openmp/SetCostmapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCostmap-response)))
  "Returns string type for a service object of type 'SetCostmap-response"
  "navfn_openmp/SetCostmapResponse")
